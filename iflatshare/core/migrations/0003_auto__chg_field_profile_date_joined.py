...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.date_joined'
        db.alter_column('core_profile', 'date_joined', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.date_joined'
        db.alter_column('core_profile', 'date_joined', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=''))
