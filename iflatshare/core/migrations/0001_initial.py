...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_address', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('house_number', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('post_code', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('street_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.create_table('core_item', (
            ...
            ('purchase_date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
